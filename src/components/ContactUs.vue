      ...
      <div class="w-full">
        <label>
          ...
          <input
            ...
            placeholder="{{ selectedLanguage === 'turkish' ? 'Adınızı ve soyadınızı girin' : selectedLanguage === 'english' ? 'Enter your name and surname' : selectedLanguage === 'arabic' ? 'أدخل اسمك الكامل' : selectedLanguage === 'french' ? 'Entrez votre nom et prénom' : '' }}"
          />
        </label>
      </div>
